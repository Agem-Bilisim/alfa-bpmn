...
import tr.com.agem.alfa.bpmn.AlfaBpmnConstants;
...
public abstract class AbstractFileFormType extends AbstractCommonFormType
{
	...
	public AbstractFormType parseInput(FormProperty property)
	{
		...
		this.upload= super.getMap().get(AbstractFileFormType.UPLOAD) != null ? AlfaBpmnConstants.Answer.YES : AlfaBpmnConstants.Answer.NO;
		this.download= super.getMap().get(AbstractFileFormType.DOWNLOAD) != null ? AlfaBpmnConstants.Answer.YES : AlfaBpmnConstants.Answer.NO;
