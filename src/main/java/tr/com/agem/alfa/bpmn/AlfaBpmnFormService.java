...
import tr.com.agem.alfa.bpmn.utils.AlfaFormValuesResolveCmd;
 ...
 *
 */
public class AlfaBpmnFormService 
{
	private final static Logger logger = Logger.getLogger(AlfaBpmnFormService.class);

	private static AlfaBpmnFormService instance;

	private AlfaBpmnFormService() {
	}
	 ...
	 */
	public static AlfaBpmnFormService getInstance() 
	{
		if (instance == null) {
			logger.debug("AlfaBpmnFormService instance is created...");
			instance= new AlfaBpmnFormService();
		}
		return instance;
	}
	...
	{
		return AlfaBpmnProcessEngine.getInstance().getProcessEngine();
	}
	...
	{
		ProcessDefinition definition = AlfaBpmnProcessEngine.getInstance().getProcessEngine().getRepositoryService()
	 ...
	 * @return
	 */
	public ProcessInstance submitStartFormData(String processDefinitionKey, AlfaFormToMapConverterInterface converter, Object properties)
	{
		ProcessDefinition definition = AlfaBpmnProcessEngine.getInstance().getProcessEngine().getRepositoryService()
				.createProcessDefinitionQuery()
				.processDefinitionKey(processDefinitionKey)
	 ...
	 * @return
	 */
	public ProcessInstance submitStartFormDataByProcessId(String processDefinitionId, AlfaFormToMapConverterInterface converter, Object properties)
	{
	 ...
	 * @param properties
	 */
	public void submitTaskFormData(String taskId, AlfaFormToMapConverterInterface converter, Object properties)
	{
	 ...
	 * @param properties
	 */
	public void saveFormData(String taskId, AlfaFormToMapConverterInterface converter, Object properties)
	{
	...
	{
		return ((ProcessEngineImpl)AlfaBpmnProcessEngine.getInstance().getProcessEngine())
				.getProcessEngineConfiguration()
				.getCommandExecutor()
				.execute(new AlfaFormValuesResolveCmd(list, taskId));
	}
